...
Página enfocada al turismo sobre la comuna Destino Cordillera, mostrando atracciones de la comuna para atraer a más personas y expandir el negocio local.  
  
Instrucciones para Ejecutar el Sitio:  
-Descargar todos los archivos y ejecutar index.html en VisualStudioCode o en el navegador de su preferencia  
